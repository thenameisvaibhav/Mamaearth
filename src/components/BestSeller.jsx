                    ...
                    <div className="productcontainer font-['Neue']">
                        <div className="w-60 md:w-80">
                            ...
                            <div className="productdesc flex items-center justify-between px-5 md:px-8 py-3 md:py-5 bg-gradient-to-r from-[#e37106ac] to-[#c81e219a] rounded-b-xl">
                                ...
                                <h3 className='font-medium md:text-xl'>₹ 337</h3>
                            </div>
                            <button className='w-full mt-1 md:mt-2 font-semibold rounded-xl py-3 md:py-5 md:text-xl bg-gradient-to-r from-[#e37106ac] to-[#c81e219a]'>Add to Cart</button>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="productcontainer font-['Neue']">
                        <div className="w-60 md:w-80">
                            ...
                            <div className="productdesc flex items-center justify-between px-5 md:px-8 py-3 md:py-5 bg-gradient-to-r from-[#e37106ac] to-[#e1a50096] rounded-b-xl">
                                ...
                                <h3 className='font-medium md:text-xl'>₹ 429</h3>
                            </div>
                            <button className='w-full mt-1 md:mt-2 font-semibold rounded-xl py-3 md:py-5 md:text-xl bg-gradient-to-r from-[#e37106ac] to-[#e1a50096]'>Add to Cart</button>
                        </div>
                    </div>
                </div>
                <div className="product3 flex-shrink-0">
                    <div className="productcontainer font-['Neue']">
                        <div className="w-60 md:w-80">
                            ...
                            <button className='w-full mt-1 md:mt-2 font-semibold rounded-xl py-3 md:py-5 md:text-xl bg-gradient-to-r from-[#e8bd7cb1] to-[#ba4e5eb2]'>Add to Cart</button>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="productcontainer font-['Neue']">
                        <div className="w-60 md:w-80">
                            ...
                            <div className="productdesc flex items-center justify-between px-5 md:px-8 py-3 md:py-5 bg-gradient-to-l from-[#e37106ac] to-[#e1a50096] rounded-b-xl">
                                ...
                                <h3 className='font-medium md:text-xl'>₹ 351</h3>
                            </div>
                            <button className='w-full mt-1 md:mt-2 font-semibold rounded-xl py-3 md:py-5 md:text-xl bg-gradient-to-l from-[#e37106ac] to-[#e1a50096]'>Add to Cart</button>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="productcontainer font-['Neue']">
                        <div className="w-60 md:w-80">
                            ...
                            <div className="productdesc flex items-center justify-between px-5 md:px-8 py-3 md:py-5 bg-gradient-to-r from-[#f8c1ffab] to-[#f2b889b6] rounded-b-xl">
                                ...
                                <h3 className='font-medium md:text-xl'>₹ 339</h3>
                            </div>
                            <button className='w-full mt-1 md:mt-2 font-semibold rounded-xl py-3 md:py-5 md:text-xl bg-gradient-to-r from-[#f8c1ffab] to-[#f2b889b6]'>Add to Cart</button>
                        </div>
                    </div>
                </div>
            </div>
