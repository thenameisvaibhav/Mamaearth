...
const Marquee = () => {
    return (
        <div className='w-full mt-9 md:mt-14'>
            <div className="text bg-gradient-to-r from-[#01afefc8] to-[#8ECC45] text-white flex whitespace-nowrap font-['Helvetica'] font-semibold uppercase overflow-hidden pt-8 md:pt-16 pb-4 md:pb-8">
                <h1
