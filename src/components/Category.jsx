    ...
    return (
        <div className='w-full my-5 md:my-10'>
            ...
            <div className="category pl-3 md:px-9 lg:px-14 w-full overflow-x-auto flex gap-3 md:gap-9 lg:gap-14 whitespace-nowrap">
                <Tilt>
                    <motion.div whileTap={{ scale: .9 }} className="category1 flex-shrink-0">
                ...
                <Tilt>
                    <motion.div whileTap={{ scale: .9 }} className="category2 flex-shrink-0">
                ...
                <Tilt>
                    <motion.div whileTap={{ scale: .9 }} className="category3 flex-shrink-0">
                        <div className="categorycontainer font-['Neue']">
                            <div className="w-60 md:w-96 h-96 md:h-[60vh] lg:h-[85vh]">
                                <div className="image w-full">
                ...
                <Tilt>
                    <motion.div whileTap={{ scale: .9 }} className="category4 flex-shrink-0">
                        <div className="categorycontainer font-['Neue']">
                            <div className="w-60 md:w-96 h-96 md:h-[60vh] lg:h-[85vh]">
                                <div className="image w-full">
