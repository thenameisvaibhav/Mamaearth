    ...
    <div className="w-full mt-5 md:mt-10">
      <div className="w-full h-full lg:h-96 bg-[url(/images/Tree.avif)] bg-cover">
        <div className="text">
          ...
          <motion.p initial={{ y: '300%', opacity: 0 }}
            whileInView={{ y: '0%', opacity: 1 }}
            viewport={{ once: true }}
            transition={{ ease: [0.16, 1, 0.3, 1], duration: .5 }} className='text-center text-sm lg:mt-20'>Trees have got life already...</motion.p>
          <motion.p initial={{ y: '300%', opacity: 0 }}
            whileInView={{ y: '0%', opacity: 1 }}
            viewport={{ once: true }}
            transition={{ ease: [0.16, 1, 0.3, 1], duration: .5 }} className='text-center text-sm mb-4 md:mb-8 lg:mb-12'>Everytime you buy from us, we plant more trees!</motion.p>
        </div>
      </div>
    </div>
  )
