...
const About = () => {
    return (
        <div className='w-full mt-5 md:mt-10'>
            <h1 className='text-5xl md:text-6xl lg:text-7xl px-5 md:px-10 lg:px-14 tracking-tighter font-semibold font-["Helvetica_Now_Display"] mb-6 md:mb-12 lg:mb-16 text-center'>Want to Achieve</h1>
            <div className="all font-['Neue_Montreal'] lg:flex">
